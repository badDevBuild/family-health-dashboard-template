...
[打开虚构数据演示](https://baddevbuild.github.io/family-health-dashboard-template/)

演示站点沿用生产页面的界面结构，包含一个五口虚构家庭、2022–2026 年共 30 次体检与就医记录，以及高血压随访、贫血闭环、脂肪肝、骨量减少和儿童近视等带报告证据的虚构病例。页面同时展示长期指标趋势、时间线和生活指南，并配有统一风格的原创插画头像。每次发布都会重新执行隐私检查、类型检查和自动化测试；真实资料不会进入 GitHub Pages。
